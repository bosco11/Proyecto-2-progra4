...
class Tienda_model extends CI_Model
{
	...
	function get_tienda_id($id) //Retorna todos los datos de una tienda en expecifico.
	{
		$query = $this->db->query("SELECT * FROM tbl_usuarios WHERE tbl_usuarios.tipo_usuario = 'Tienda' AND tbl_usuarios.id_usuarios = $id");
	...
	public function eliminardenunciaTienda($params){
		$this->db->delete('tbl_denuncias', $params);
	}
	...
	{
		$query = $this->db->query("SELECT * FROM tbl_denuncias WHERE tbl_denuncias.tienda_id_usuarios = $id");
		return $query->num_rows();
	}
