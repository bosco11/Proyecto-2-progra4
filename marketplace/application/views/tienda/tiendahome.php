	...
	<div id="panel_app">
				...
				<div class="collapse navbar-collapse" id="navbarSupportedContent">
					<ul class="navbar-nav mr-auto">
						<li class="nav-item active">
							<a class="nav-link waves-effect" href="<?php echo site_url('tienda/mantCategoria') ?>">Categorias <!-- Se crea un boton para ir a la vista de mantenimineto de categorias -->
								<span class="sr-only">(current)</span>
							</a>
						</li>
						<li class="nav-item">
							<a class="nav-link waves-effect" href="<?php echo site_url('tienda/ventas/' . $this->session->userdata['logged_in']['users_id']); ?>">Reporte de ventas <!-- Se crea un boton para ir a la vista de reportes de ventas -->
							</a>
						</li>
					</ul>
					<ul class="navbar-nav nav-flex-icons ml_auto">
						<li class="nav-item dropdown notifications-nav ">
							...
							<div class="dropdown-menu dropdown-menu-right" aria-labelledby="navbarDropdownMenuLink151"> <!-- Se crea un menu modal donde se muestran las notificaiones-->
						...
						<li class="nav-item dropdown">
							...
							<div class="dropdown-menu dropdown-menu-lg-right" aria-labelledby="navbarDropdownMenuLink-55"><!-- Se crea un menu modal donde se le muestran opcones de ver perfil, editar perfil y salir -->
		...
		<nav class="navbar navbar-dark bg-dark justify-content-between">
			<div class="container-fluid">
				...
				<?php echo form_open('tienda/addProducto/1'); ?><!-- Se crea un form para ir a la vista de agregar productos -->
				...
				<?php echo form_close(); ?>
				<?php echo form_open('tienda/viewSuscriptores/' . $this->session->userdata['logged_in']['users_id']); ?><!-- Se crea un form para ir a la vista de ver los suscriptores -->
			...
			<div class="box-header">
				...
				<div id="tableview">
					<table class="table table-striped table-dark" id="table">
						...
						<tbody id="tbTable">
							<?php foreach ($productos as $pro) { ?> <!-- Se carga un tableview con todos los productos -->
