<div id="panel_app">
	...
	<div id="edit_panel">
		...
		<div class="form-group">
			<input type="number" name="txt_telefono" value="<?php echo $this->input->post('txt_telefono'); ?>" class="cajatexto" id="txt_cedula" />
		...
		<div class="form-group">
			<input type="email" name="txt_correo" value="<?php echo $this->input->post('txt_correo'); ?>" class="cajatexto" id="txt_cedula" />
		...
		<div class="form-group">
			<input type="text" name="txt_pais" value="<?php echo $this->input->post('txt_pais'); ?>" class="cajatexto" id="txt_cedula" />
