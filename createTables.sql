...
CREATE TABLE IF NOT EXISTS `bd_marketplace`.`tbl_compras` (
  ...
  CONSTRAINT `fk_tbl_compras_tbl_formas_pago1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tbl_compras_tbl_direcciones1`
    FOREIGN KEY (`id_direcciones`)
    REFERENCES `bd_marketplace`.`tbl_direcciones` (`id_direcciones`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tbl_compras_tbl_premios1`
    FOREIGN KEY (`id_premios`)
    REFERENCES `bd_marketplace`.`tbl_premios` (`id_premios`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `bd_marketplace`.`tbl_notificaciones` (
  ...
  CONSTRAINT `fk_tbl_notificaciones_tbl_usuarios1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tbl_notificaciones_tbl_productos1`
    FOREIGN KEY (`id_productos`)
    REFERENCES `bd_marketplace`.`tbl_productos` (`id_productos`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
...
-- -----------------------------------------------------
-- Table `bd_marketplace`.`tbl_denuncias`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `bd_marketplace`.`tbl_denuncias` (
  ...
  CONSTRAINT `fk_tbl_denuncias_tbl_usuarios1`
    ...
    ON DELETE NO ACTION
    ON UPDATE NO ACTION,
  CONSTRAINT `fk_tbl_denuncias_tbl_usuarios2`
    FOREIGN KEY (`comprador_id_usuarios`)
    REFERENCES `bd_marketplace`.`tbl_usuarios` (`id_usuarios`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
