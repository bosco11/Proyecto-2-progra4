...
-- -----------------------------------------------------
-- Table `mydb`.`tbl_tipo_usuarios`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`tbl_tipo_usuarios` (
...
CREATE TABLE IF NOT EXISTS `mydb`.`tbl_usuarios` (
  ...
  `tbl_tipo_usuarios_id_tipos_usuarios` BIGINT NOT NULL,
  `pais` VARCHAR(100) NOT NULL,
  `denuncias` BIGINT NULL,
  `fecha_giros` DATE NULL,
  `cantidad_giros` BIGINT NULL,
  PRIMARY KEY (`id_usuarios`),
  INDEX `fk_tbl_usuarios_tbl_tipo_usuarios_idx` (`tbl_tipo_usuarios_id_tipos_usuarios` ASC) VISIBLE,
  CONSTRAINT `fk_tbl_usuarios_tbl_tipo_usuarios`
    FOREIGN KEY (`tbl_tipo_usuarios_id_tipos_usuarios`)
    REFERENCES `mydb`.`tbl_tipo_usuarios` (`id_tipos_usuarios`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
CREATE TABLE IF NOT EXISTS `mydb`.`tbl_redes_sociales` (
  ...
  `tbl_usuarios_id_usuarios` BIGINT NOT NULL,
  PRIMARY KEY (`id_redes_sociales`),
  INDEX `fk_tbl_redes_sociales_tbl_usuarios1_idx` (`tbl_usuarios_id_usuarios` ASC) VISIBLE,
  CONSTRAINT `fk_tbl_redes_sociales_tbl_usuarios1`
    FOREIGN KEY (`tbl_usuarios_id_usuarios`)
    REFERENCES `mydb`.`tbl_usuarios` (`id_usuarios`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`tbl_direcciones`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`tbl_direcciones` (
  ...
  INDEX `fk_tbl_direcciones_tbl_usuarios1_idx` (`tbl_usuarios_id_usuarios` ASC) VISIBLE,
...
-- -----------------------------------------------------
-- Table `mydb`.`tbl_formas_pago`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`tbl_formas_pago` (
  ...
  INDEX `fk_tbl_formas_pago_tbl_usuarios1_idx` (`tbl_usuarios_id_usuarios` ASC) VISIBLE,
...
CREATE TABLE IF NOT EXISTS `mydb`.`tbl_productos` (
  ...
  CONSTRAINT `fk_tbl_productos_tbl_categorias1`
    ...
    REFERENCES `mydb`.`tbl_categorias` (`id_categorias`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`tbl_galeria`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`tbl_galeria` (
  ...
  CONSTRAINT `fk_tbl_galeria_tbl_productos1`
    ...
    REFERENCES `mydb`.`tbl_productos` (`id_productos`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`tbl_suscriptores`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`tbl_suscriptores` (
...
-- -----------------------------------------------------
-- Table `mydb`.`tbl_compras`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`tbl_compras` (
  ...
  CONSTRAINT `fk_tbl_compras_tbl_formas_pago1`
    ...
    REFERENCES `mydb`.`tbl_formas_pago` (`id_formas_pago`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`tbl_productos_compras`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`tbl_productos_compras` (
  ...
  CONSTRAINT `fk_tbl_productos_compras_tbl_compras1`
    ...
    REFERENCES `mydb`.`tbl_compras` (`id_compras`)
    ON DELETE NO ACTION
    ON UPDATE NO ACTION)
ENGINE = InnoDB;
...
-- -----------------------------------------------------
-- Table `mydb`.`tbl_carrito_deseos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`tbl_carrito_deseos` (
  `id_usuarios` BIGINT NOT NULL,
  `id_productos` BIGINT NOT NULL,
...
-- -----------------------------------------------------
-- Table `mydb`.`tbl_calificacion_productos`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`tbl_calificacion_productos` (
  `id_productos` BIGINT NOT NULL,
...
-- -----------------------------------------------------
-- Table `mydb`.`tbl_calificacion_tienda`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`tbl_calificacion_tienda` (
  `calificacion` BIGINT NOT NULL,
  `tienda_id_usuarios` BIGINT NOT NULL,
  `comprador_id_usuarios` BIGINT NOT NULL,
  PRIMARY KEY (`tienda_id_usuarios`, `comprador_id_usuarios`),
...
-- -----------------------------------------------------
-- Table `mydb`.`tbl_premios`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `mydb`.`tbl_premios` (
